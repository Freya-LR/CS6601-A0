...
def display_assignment_0_output(submission):
...
def main():
  ...
  parser.add_argument('part', choices = ['assignment_0'])
  ...
  if args.part == 'assignment_0':
    require_pledges()
    quiz = 'assignment_0'
    filenames = ["test_submission.py"]
  ...
  if args.part == 'assignment_0':
    display_assignment_0_output(submission)
